...
-- Habilitar la salida de DBMS_OUTPUT para la primera funci�n
SET SERVEROUTPUT ON;
...
DECLARE
    v_total NUMBER;
BEGIN
    v_total := calcular_total_factura(2); -- Aqui hay que cambiar el ID de la factura seg�n sea necesario
...
-- Funci�n para calcular el total de todas las facturas
...
-- Funci�n para obtener el total de los servicios de una oficina
...
BEGIN
    v_cursor := obtener_detalle_factura(1); -- Se debe modificar el ID de la factura seg�n sea necesario
...
-- Funci�n para obtener el contacto con m�s facturas
...
-- Funci�n para calcular el total de ventas de un repuesto
...
-- Funci�n para contar el n�mero de veh�culos activos
...
-- Funci�n para obtener el precio promedio de los servicios
...
-- Funci�n para obtener el n�mero de empleados en cada cargo
...
DECLARE
    v_num_empleados INTEGER;
BEGIN
    v_num_empleados := obtener_empleados_por_cargo('Contador'); -- Se debe de modificar el cargo seg�n sea necesario
    DBMS_OUTPUT.PUT_LINE('N�mero de empleados en el cargo de Contador: ' || v_num_empleados);
END;
