...
if (isset($_GET['id'])) {
    ...
    $sql = 'BEGIN delete_vehiculo(:id_vehiculo); END;';
    ...
    if ($r) {
        // Redirigir a la página principal de vehículos después de la eliminación exitosa
        header('Location: Tabla_Vehiculo.php');
        exit(); // Asegura que el script se detenga después de la redirección
    } else {
        $e = oci_error($stid);
        echo "<p>Error al eliminar el vehículo: " . htmlentities($e['message'], ENT_QUOTES) . "</p>";
    }
