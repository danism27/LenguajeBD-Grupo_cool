<?php
if (isset($_GET['cod_servicio']) && isset($_GET['nombre_servicio']) && isset($_GET['descripcion_servicio']) && isset($_GET['precio_servicio'])) {
    ...
    // Preparar la consulta para crear el servicio
    $sql = 'BEGIN insert_servicio(:cod_servicio, :nombre_servicio, :descripcion_servicio, :precio_servicio); END;';
    ...
    if (!$r) {
        $e = oci_error($stid);
        echo "<p>Error al crear el servicio: " . htmlentities($e['message'], ENT_QUOTES) . "</p>";
        exit;
    }
