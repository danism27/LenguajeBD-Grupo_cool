    ...
    <header style="margin-bottom: 2%">
        ...
        <div class="container">
            ...
            <div class="mb-3 d-flex justify-content-center align-items-center">
                <!-- Mini Formulario para Leer Servicio Específico -->
                <form action="Leer_Servicio.php" method="GET" class="form-inline d-flex mr-3">
                    <label for="id_servicio" class="mr-2">Buscar Servicio por ID:</label>
                    <input type="number" id="id_servicio" name="id_servicio" class="form-control mr-2" required>
            ...
            <div class="row">
                <div class="col">
                    ...
                    $stid = oci_parse($conn, 'SELECT * FROM SERVICIOS ORDER BY ID_SERVICIO ASC');
                    oci_execute($stid);
                    ...
                    while ($row = oci_fetch_array($stid, OCI_ASSOC + OCI_RETURN_NULLS)) {
                        echo "<tr>\n";
                        echo "<td>" . htmlentities($row['ID_SERVICIO'], ENT_QUOTES) . "</td>\n";
