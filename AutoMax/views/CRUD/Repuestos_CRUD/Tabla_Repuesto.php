        ...
        <div class="container">
            ...
            <div class="mb-3 d-flex justify-content-center align-items-center">
                ...
                <button type="button" class="btn btn-success ml-3"
                    onclick="window.location.href='Crear_Repuesto.php'">Crear</button>
            </div>
            ...
            <div class="row">
                <div class="col">
                    ...
                    $stid = oci_parse($conn, 'SELECT * FROM REPUESTOS ORDER BY ID_REPUESTO ASC');
                    oci_execute($stid);
                    ...
                    echo "<tr>\n";
                    echo "<th>ID REPUESTO</th>\n";
                    echo "<th>CÓDIGO REPUESTO</th>\n";
                    echo "<th>NOMBRE REPUESTO</th>\n";
