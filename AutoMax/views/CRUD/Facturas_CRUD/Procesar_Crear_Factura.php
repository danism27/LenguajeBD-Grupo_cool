...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $stid = oci_parse($conn, 'BEGIN insert_factura(:cod_factura, :cod_cliente, TO_DATE(:fecha_factura, \'YYYY-MM-DD\'), :total_factura); END;');
    ...
    if (oci_execute($stid)) {
        echo "<p>Factura creada exitosamente</p>";
    } else {
        $e = oci_error($stid);
        echo "<p>Error al crear la factura: " . htmlentities($e['message'], ENT_QUOTES) . "</p>";
    }
