...
// Llamar a una función del paquete repuestos_pkg para obtener los repuestos
$sql = 'BEGIN :cursor := repuestos_pkg.obtener_repuestos; END;';
...
echo '<h2 class="text-center">Lista de Repuestos</h2>';
echo '<table class="table table-striped table-bordered">';
echo '<thead class="thead-dark">';
echo '<tr>';
echo '<th scope="col">ID Repuesto</th>';
...
while (($row = oci_fetch_assoc($cursor)) != false) {
    echo "<tr>";
    echo "<td>" . htmlentities($row['ID_REPUESTO'], ENT_QUOTES) . "</td>";
