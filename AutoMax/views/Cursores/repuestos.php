...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    try {
        ...
        $sql_repuestos = "SELECT * FROM REPUESTOS";
        $stmt = $conexion->prepare($sql_repuestos);
        ...
        while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
            echo "<div class='repuesto'>ID: " . $row['ID_REPUESTO'] . " - Nombre: " . $row['NOMBRE_REPUESTO'] . " - Precio: " . $row['PRECIO_REPUESTO'] . "</div>";
        }
        echo "</div>";

        echo "<div class='success'>Repuestos procesados exitosamente.</div>";
        
    } catch (PDOException $e) {
        echo "<div class='error'>Error al procesar los repuestos: " . $e->getMessage() . "</div>";
    }
...
<head>
    ...
    <title>Procesar Repuestos</title>
    <style>
        body {
