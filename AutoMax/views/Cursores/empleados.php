...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    try {
        ...
        $stmt = $conexion->prepare($sql_empleados);
        ...
        while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
            echo "<div class='empleado'>ID: " . $row['ID_EMPLEADO'] . " - Nombre: " . $row['NOMBRE_EMPLEADO'] . " " . $row['APELLIDO_EMPLEADO'] . " - Cargo: " . $row['CARGO_EMPLEADO'] . "</div>";
        }
        echo "</div>";

        echo "<div class='success'>Empleados procesados exitosamente.</div>";
        
    } catch (PDOException $e) {
        echo "<div class='error'>Error al procesar los empleados: " . $e->getMessage() . "</div>";
    }
...
<head>
    ...
    <title>Procesar Empleados</title>
    <style>
        body {
