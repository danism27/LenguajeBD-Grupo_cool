...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    try {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
            echo "<div class='servicio'>ID: " . $row['ID_SERVICIO'] . " - Nombre: " . $row['NOMBRE_SERVICIO'] . " - Precio: " . $row['PRECIO_SERVICIO'] . "</div>";
        }
        echo "</div>";

        echo "<div class='success'>Servicios procesados exitosamente.</div>";
        
    } catch (PDOException $e) {
        echo "<div class='error'>Error al procesar los servicios: " . $e->getMessage() . "</div>";
    }
...
<head>
    ...
    <title>Procesar Servicios</title>
    <style>
        body {
