...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    try {
        ...
        $stmt = $conexion->prepare($sql_contactos_facturas);
        ...
        while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
            echo "<div class='contacto-factura'>
                Contacto ID: " . $row['ID_CONTACTO'] . " - Nombre: " . $row['NOMBRE_CONTACTO'] . " - Factura ID: " . $row['ID_FACTURA'] . " - Fecha: " . $row['FECHA_FACTURA'] . " - Total: " . $row['TOTAL_FACTURA'] . "
            </div>";
        }
        echo "</div>";

        echo "<div class='success'>Datos de contactos y facturas procesados exitosamente.</div>";
...
<head>
    ...
    <title>Procesar Contactos y Facturas</title>
    <style>
        body {
...
<body>
    <div class="container">
        <h1>Procesar Contactos y Facturas</h1>
