...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    try {
        ...
        $sql_detalle_factura = "SELECT * FROM DETALLE_FACTURA";
        $stmt = $conexion->prepare($sql_detalle_factura);
        ...
        while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
            echo "<div class='detalle'>ID: " . $row['ID_DETALLE_FACTURA'] . " - Cantidad: " . $row['CANTIDAD'] . "</div>";
        }
        echo "</div>";

        echo "<div class='success'>Detalles de factura procesados exitosamente.</div>";
        
    } catch (PDOException $e) {
        echo "<div class='error'>Error al procesar los detalles de factura: " . $e->getMessage() . "</div>";
    }
...
<head>
    ...
    <title>Procesar Detalles de Factura</title>
    <style>
        body {
...
<body>
    <div class="container">
        <h1>Procesar Detalles de Factura</h1>
