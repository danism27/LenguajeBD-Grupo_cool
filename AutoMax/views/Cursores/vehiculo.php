...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    try {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
            echo "<div class='vehiculo'>ID: " . $row['ID_VEHICULO'] . " - Placa: " . $row['NUM_PLACA'] . " - Marca: " . $row['MARCA'] . "</div>";
        }
        echo "</div>";

        echo "<div class='success'>Vehículos procesados exitosamente.</div>";
        
    } catch (PDOException $e) {
        echo "<div class='error'>Error al procesar los vehículos: " . $e->getMessage() . "</div>";
    }
...
<head>
    ...
    <title>Procesar Vehículos</title>
    <style>
        body {
