...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    try {
        ...
        $stmt = $conexion->prepare($sql_oficinas);
        ...
        while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
            echo "<div class='oficina'>ID: " . $row['ID_OFICINA'] . " - Nombre: " . $row['NOMBRE_OFICINA'] . "</div>";
        }
        echo "</div>";

        echo "<div class='success'>Oficinas procesadas exitosamente.</div>";
        
    } catch (PDOException $e) {
        echo "<div class='error'>Error al procesar las oficinas: " . $e->getMessage() . "</div>";
    }
