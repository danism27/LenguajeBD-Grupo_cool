...
if (isset($_GET['id'])) {
    ...
    // Obtener los datos actuales de la oficina
...
<head>
    <title>Actualizar Oficina - Paso 1</title>
    <meta charset="utf-8">
...
<body>
    ...
    <header style="margin-bottom: 2%">
        ...
        <div class="container">
            <h1 class="text-center">Actualizar Oficina</h1>
            <!-- Formulario para ver y enviar los datos de la oficina -->
            <form action="Procesar_Actulizar_Oficina.php" method="GET">
                <!-- Campo oculto para el ID de la oficina -->
                <input type="hidden" name="id_oficina" value="<?php echo htmlentities($id_oficina, ENT_QUOTES); ?>">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="nombre_oficina" name="nombre_oficina"
                        value="<?php echo htmlentities($nombre_oficina, ENT_QUOTES); ?>" required>
                </div>
                ...
                <a class="btn btn-secondary" href="Tabla_Oficinas.php">Volver</a>
            </form>
        </div>
