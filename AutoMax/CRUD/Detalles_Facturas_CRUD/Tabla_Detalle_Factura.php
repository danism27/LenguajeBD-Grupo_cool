    ...
    <header style="margin-bottom: 2%">
        ...
        <div class="container">
            ...
            <div class="mb-3 d-flex justify-content-center align-items-center">
                <!-- Mini Formulario para Leer Detalle de Factura Específico -->
                <form action="leer_detalle_factura.php" method="GET" class="form-inline d-flex mr-3">
                    <label for="id_detalle_factura" class="mr-2">Buscar Detalle por ID:</label>
                    <input type="number" id="id_detalle_factura" name="id_detalle_factura" class="form-control mr-2" required>
                    <button type="submit" class="btn btn-primary">Leer</button>
                </form>
                <button type="button" class="btn btn-success ml-3"
                    onclick="window.location.href='Crear_Detalle_Factura.php'">Crear</button>
            </div>
            ...
            <div class="row">
                <div class="col">
                    ...
                    // Consultar los detalles de las facturas
                    $stid = oci_parse($conn, 'SELECT * FROM DETALLE_FACTURA ORDER BY ID_DETALLE_FACTURA ASC');
                    oci_execute($stid);
                    ...
                    while ($row = oci_fetch_array($stid, OCI_ASSOC + OCI_RETURN_NULLS)) {
                        echo "<tr>\n";
                        echo "<td>" . htmlentities($row['ID_DETALLE_FACTURA'], ENT_QUOTES) . "</td>\n";
                        ...
                        echo "<td><a href='Actualizar_Detalle_Factura.php?id=" . $row['ID_DETALLE_FACTURA'] . "' class='btn btn-warning btn-sm'>Actualizar</a></td>\n";
                        echo "<td><a href='Procesar_Eliminar_Detalle_Factura.php?id=" . $row['ID_DETALLE_FACTURA'] . "' class='btn btn-danger btn-sm'>Eliminar</a></td>\n";
                        echo "</tr>\n";
                    }
